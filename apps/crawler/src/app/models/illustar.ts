...
const event = composite({
  ...
  place: scalar.string(),
  start_date: scalar.nullable(scalar.number()),
  end_date: scalar.nullable(scalar.number()),
  show_date: scalar.string(),
  ticket_open_date: scalar.nullable(scalar.number()),
  image: scalar.number(),
  ticket_close_date: scalar.nullable(scalar.number()),
